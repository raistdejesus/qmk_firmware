...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
		    					                    LT(4,KC_SPACE), MT(MOD_MEH, KC_DEL),                 TO(1), LT(4,KC_SPACE)
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
  ),
  ...
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    MT(MOD_LSFT,KC_TAB), KC_EQL,    KC_LCBR,   MT(MOD_LALT,KC_LBRC), KC_DEL,                             KC_BSPC, MT(MOD_RGUI,KC_RBRC), KC_RCBR, KC_MINS, MT(MOD_RSFT,KC_ENTER),
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    KC_GRAVE,            S(KC_DEL), C(KC_INS), S(KC_INS),            KC_QUOT,                            KC_BSLS, G(KC_V),              G(KC_C), G(KC_X), TO(3),
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
		    					                                     LT(4,KC_SPACE), TO(0),              TO(2), LT(4,KC_SPACE) 
  ),

  [2] = LAYOUT(
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    KC_ESCAPE,           KC_MEDIA_PLAY_PAUSE, KC_MEDIA_PREV_TRACK, KC_MEDIA_NEXT_TRACK, LSFT(KC_MINS),   KC_F9,   KC_F10,  KC_F11, KC_F12, KC_TRANSPARENT,
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    MT(MOD_LSFT,KC_TAB), KC_TRANSPARENT,      KC_AUDIO_VOL_DOWN,   KC_AUDIO_VOL_UP,     LSFT(KC_EQL),    KC_F5,   KC_F6,   KC_F7,  KC_8,   KC_ENTER,
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    KC_CAPS,             KC_KP_ASTERISK,      KC_BRIGHTNESS_DOWN,  KC_BRIGHTNESS_UP,    KC_KP_DOT,       KC_F1,   KC_F2,   KC_F3,  KC_F4,  TO(4),
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
  ...
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    TD(DANCE_58),   KC_MS_BTN2,     KC_MS_WH_UP,    KC_MS_WH_DOWN,  KC_MS_BTN1,                          KC_NO,         KC_MS_ACCEL0,         KC_MS_ACCEL1,       KC_MS_ACCEL2,  KC_NO, 
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
                                                                     KC_TRANSPARENT, TO(0),              TO(1), KC_SPACE
  ),

  [4] = LAYOUT(
    KC_NO,    KC_NO,    KC_NO,    KC_NO,  KC_NO,                                                         KC_NO,     KC_HOME,     KC_UP,     KC_PGUP,    KC_BSPC, 
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    KC_LSFT,  KC_LCTL, KC_LALT, KC_LGUI,  MT(MOD_LGUI,KC_DEL),                                           KC_NO,     KC_LEFT,     KC_DOWN,   KC_RIGHT,  KC_ENTER,     
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
    KC_NO,    KC_CUT,  KC_COPY, KC_PASTE, KC_NO,                                                         KC_NO,     KC_END,      KC_NO,     KC_PGDN,   KC_NO, 
  //---------------------------------------------------------------------------------------              ----------------------------------------------------------------------------------
                                                                     KC_TRANSPARENT, TO(0),              TO(2), KC_RALT
  )
};
